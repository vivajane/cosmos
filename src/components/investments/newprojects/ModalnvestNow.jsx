...
const ModalnvestNow = ({ show , setShow}) => {
  return (
    <div className="bg-[rgba(0,0,0,0.9)] fixed flex flex-col justify-center items-center top-[0] bottom-0 right-0 left-0">
      <div className="bg-white p-6 rounded-lg h-auto space-y-3 shadow-lg w-auto">
        ...
        <form>
            ...
            <span className="w-full"><Button variant="tertiarysec" size="sm">Cancel</Button></span>
            <span className="w-full"><Button variant="tertiary" size="sm">Confirm Investment</Button></span>
            </div>
        </form>
      </div>
    </div>
