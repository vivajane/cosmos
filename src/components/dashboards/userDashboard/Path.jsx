        ...
        <ul className='flex  gap-20 items-center justify-between'>
            {
                paths.map((path)=>{
                    return(
                        <li className="border-[#1BA019] px-3  w-full rounded-lg border-[1px]" key={path.id}>
                            ...
                            <div className='py-3 space-y-2 text-left'>
                                ...
                                <img className='text-[#1BA019] ' src={path.img} alt="path" />
                                <img className='absolute top-0 right-4' src={pathh} alt="h" />
                                </div>
                            </div>
                        </li>
                    )
