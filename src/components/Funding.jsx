...
const Funding = () => {
  ...
  <div className="flex items-center text-center lg:py-36 xl:28 py-56 sm:py-60 justify-center md:py-44 flex-col  relative z-10  text-white">
    <h1 className='font-semibold py-8 sm:py-[1px] text-2xl sm:text-3xl md:text-5xl lg:text-6xl text-center font-sanns lg:leading-[76px] sm:leading-[45px] md:leading-[60px] leading-[35px]'>Funding Farmers, Harvesting <br /> Hope for the Future</h1>
    <p className='font-medium font-sanns sm:pt-6 pt-0 sm:py-8 text-sm sm:text-base lg:text-lg  text-center'>Join thousands of investors funding Nigeria’s agricultural  <br />
