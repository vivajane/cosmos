...
const PendingConfirm = () => {
  return (
    ...
    <div className=" text-center mx-auto  h-8 w-8 ">
        ...
        <div>
        <h1 className="font-sanns text-center font-semibold text-base text-[#1E1E1E]">Are you sure you want to pend the selected Issue</h1>
      </div>
      <div>
        <Button  >Yes, Please pend</Button>
      </div>
      </div>
