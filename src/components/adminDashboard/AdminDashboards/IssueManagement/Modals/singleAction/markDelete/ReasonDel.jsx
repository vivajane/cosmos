  ...
  return (
    <div className="bg-[rgba(0,0,0,0.9)] fixed flex flex-col justify-center items-center top-[0] bottom-0 right-0 left-0">
      <div className="bg-white p-6 rounded-lg max-h-[50vh] overflow-y-auto space-y-2 shadow-lg w-1/2">
        ...
        <h1 className="text-2xl text-[#6B911B] font-medium">Reason for deleting Issues</h1>
        <FaTimes size={20} />
        </div>
        <hr />
        ...
        <div className="text-base space-y-3 font-semibold">
          ...
          <p className="text-[#1E1E1EBF] font-medium text-sm">Please add reason for deleting this issue</p>
        </div>
        <form >
        ...
        Cancel
          ...
          <button className="bg-[#BC332A] py-2 px-3 w-full border  rounded-md text-[#FFFFFF]">
            Delete Issue
          </button>
        </div>
      </div>
