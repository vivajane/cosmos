...
const MarkAsResolved = ({ setMarkAsResolved, setSuccessBulk}) => {
  return (
    <div className="bg-[rgba(0,0,0,0.9)] fixed flex flex-col justify-center items-center top-[0] bottom-0 right-0 left-0">
      <div className="bg-white p-6 rounded-lg max-h-[90vh] overflow-y-auto space-y-2 shadow-lg md:w-96 w-80">
        <div onClick={setMarkAsResolved} className="flex justify-end">
    ...
    <div className=" text-center mx-auto  h-8 w-8 ">
        ...
        <div>
        <h1 className="font-sanns text-center font-semibold text-base text-[#1E1E1E]">Are you sure you want to Resolve 12 Issues</h1>
      </div>
      <div>
        <Button onClick={() => setSuccessBulk(true) || setMarkAsResolved(false)} >Yes, Mark as resolved</Button>
      </div>
      </div>
