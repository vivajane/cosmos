...
const BulkSure = ({setBulkPending, setSuccessBulkPend}) => {
  return (
    ...
    <div className=" text-center mx-auto  h-8 w-8 ">
        ...
        <div>
        <h1 className="font-sanns text-center font-semibold text-base text-[#1E1E1E]">Are you sure you want to Pend 12 Issues</h1>
      </div>
      <div>
        <Button onClick={() => setSuccessBulkPend(true) || setBulkPending(false)}>Yes, Mark 12 issues as Pending</Button>
      </div>
      </div>
